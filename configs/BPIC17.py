...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--init_epochs', default=15, type=int)
    subparsers.add_argument('--attributes', default=None, type=str)
    subparsers.add_argument('--prefix_length', default=10, type=int)
    subparsers.add_argument('--window_size', default=5000, type=int)
    ...
    subparsers.add_argument('--num_heads', default=23, help='Number of output heads')
