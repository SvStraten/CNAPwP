...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--window_size', default=1500, type=int)
    ...
    subparsers.add_argument('--num_heads', default=7, help='Number of output heads')
    ...
    subparsers.add_argument('--weight_decay', type=float, default=0.004, help='weight decay (default: 0.0)')
