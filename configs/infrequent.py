...
def get_args_parser(subparsers):
    subparsers.add_argument('--batch_size', default=25, type=int, help='Batch size')
    subparsers.add_argument('--epochs', default=5, type=int)
    subparsers.add_argument('--init_epochs', default=25, type=int)
    ...
    subparsers.add_argument('--buffer_size', default = 150, type = int)
    subparsers.add_argument('--boundary', default = 0.41, type = int)
    subparsers.add_argument('--prefix', default = False, type = int)
    ...
    subparsers.add_argument('--nrOfEvents', default = 21, type=int, help='Number of events')
